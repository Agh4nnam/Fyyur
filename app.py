...
def venues():
  ...
  for city in cities:
    ...
    for venue in venues:
      ...
      "id": venue.id,
      "name": venue.name,
      #"num_upcoming_shows": Venue.query.count()
      }
...
def create_venue_submission():
  ...
  try:
    data = request.form
    print(data['name'])
    venue = Venue(name=data['name'], city=data['city'], state=data['state'], address=data['address'], phone=data['phone'], genres=getlist('genres'),facebook_link=data['facebook_link'])
